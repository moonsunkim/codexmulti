...
pub fn assertProjectionFieldCoverage() void {
    comptime {
        ...
        assertSourceFieldsBackedByWire(shell.Model, ShellWire, &.{ "view", "service", "now_unix_s" });
        ...
        }, &.{ "codex_usage_window", "codex_show_model_limits", "launch_at_login", "launch_at_login_registration_failed", "auto_refresh_minutes", "auto_refresh_account_count", "proxy_enabled", "proxy_enabled_detail_text", "proxy_account_count", "proxy_row_count", "row_count", "usage_count", "unified_row_count", "names", "names_len", "text", "text_len" });
