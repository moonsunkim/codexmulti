...
struct SettingsView: Decodable, Sendable, Equatable {
    ...
    let language_label_japanese: String?
    let language_label_chinese_simplified: String?
    let language_label_spanish: String?
    ...
    enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case language_label_english, language_label_korean, language_label_japanese
        case language_label_chinese_simplified, language_label_spanish
